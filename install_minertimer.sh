...
install -d -m 0755 -o root -g wheel /Users/Shared/minertimer
install -m 0755 -o root -g wheel minertimer.sh /Users/Shared/minertimer/minertimer.sh

# Step 2: Place the PLIST file where it belongs
install -m 0644 -o root -g wheel com.soferio.minertimer_daily_timer.plist /Library/LaunchDaemons/com.soferio.minertimer_daily_timer.plist
